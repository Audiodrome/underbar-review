(function() {
  ...
  describe('Part II', function() {
    ...
    describe('memoize', function() {
      ...
      it('should run with 1 arg?', function() {
        var myfunction = function(x, y) { return x + y + 1; };
        var memoFunction = _.memoize(myfunction);
        memoFunction(1, 2);
        memoFunction(2, 2);
        expect(memoFunction(1, 2)).to.equal(4);
        expect(memoFunction(2, 2)).to.equal(5);
